...
final class AdminUserCrudController extends AbstractController
{
    ...
    {
        return $this->render('admin_user_crud/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_user_crud/new.html.twig', [
            'user' => $user,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin_user_crud/show.html.twig', [
            'user' => $user,
        ]);
    }
    ...
    public function edit(Request $request, User $user, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_user_crud/edit.html.twig', [
            'user' => $user,
            'form' => $form,
        ]);
    }
